...
| Trusted Google CSS2 `@import` | Parsed into `ImportGoogleFont` install requests and committed as Google font entries that load from the CSS2 CDN (no download) |
